...
N2 = 5; % compensation efficiency from 1 to 0.6
ColM3 = ColorVector([198 219 239;33 113 181],N2); % blue range

for i=1:N2
    m = [0 0.5+0.1*i];
    ztv = [0.1 0.5]; % different loads
    p = [g ph kp kn kc th ztv n m ];
    plot(NullClines(x,p,op),x,'Color',ColM3(i,:),'LineWidth',2), hold on
end
